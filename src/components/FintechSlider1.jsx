const FintechSlider1 = () => {
    return(
         <section className="box-border grid grid-cols-1 md:grid-cols-2 text-[#1D2328] leading-[120%] tracking-[-3%] md:min-h-[528px] xl:min-h-screen 2xl:min-h-[958px] w-screen">
            {/* Grid 1 */}
             <div className="h-full relative">
                {/* layer-1 */}
                <div className="bg-[#D6F6DD] p-[24px] lg:p-[40px] h-full md:h-[66%] relative">
                    ...
                    <div className="flex flex-col md:flex-row items-start justify-start gap-[16px] md:gap-0">
                        <div>
                            <h5 className="font-[500] text-[80px] md:text-[70px] xl:text-[88px] 2xl:text-[110px] leading-[100%] tracking-[-3%]">100%</h5>
                ...
                <div className="box-border hidden md:grid grid-cols-2 min-h-[34%]">
                    <div className="p-[24px] xl:p-[40px] bg-[#DAC4F7]">
                        ...
                        <div className="mt-[43px] xl:mt-[71px] 2xl:mt-[85px] border border-[#BF4142] border-x-0 border-b-0 pt-[10px] xl:pt-[16px]">
             ...
             <section className="relative">
                {/* layer 1 */}
                <section className="md:min-h-[26%] p-[24px] md:p-[40px] bg-[#EBD2B3] flex justify-between items-start relative">
                     <div className="flex flex-col md:flex-row items-end justify-start gap-[16px] md:gap-[40px]">
                        <div>
                            <h5 className="font-[500] text-[80px] md:text-[70px] xl:text-[80px] 2xl:text-[96px] leading-[100%] tracking-[-3%]">56%</h5>
                            <div className="leading-[120%]">
                              <span className="text-[14px] md:text-[10px] xl:text-[16px] 2xl:text-[19px] leading-[120%]">Respondents in</span>
                              <p className="text-[20px] md:text-[14px] xl:text-[25px] 2xl:text-[28px] leading-[120%]">Benin(n=50)</p>
                            </div>
                        ...
                        <div className="w-[138px] 2xl:w-[168px] text-[16px] 2xl:text-[18px]">
