...
const COLORS = {
  DIV1: "bg-[#3E2F5B]", // Box 1 (493px)
  DIV2_3_MERGED: "bg-[#000F07]", // Merged Box (245px) - Using Div3's color
  DIV4: "bg-[gray]", // Box 4 (555px)
  DIV5: "bg-[#D7253D]", // Box 5 (307px)
  DIV6: "bg-[#126F63]", // Box 6 (307px)
};
 ...
 */
const EdTechPanel: React.FC = () => {
  return (
    <section className="w-full bg-[#BF4142]">
      <div
        className={`
      ...
      >
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="flex justify-start">
              <div className="flex flex-col gap-1">
                <h3 className="font-medium text-[88px] tracking-[0.3]">73%</h3>
            ...
            <div className="flex flex-col gap-1">
                <h3 className="font-medium text-[88px] tracking-[0.3]">64%</h3>
                <p className="font-normal text-sm">Respondents in</p>
            ...
            <div className="flex justify-end items-end">
              ...
              <div className="flex">
              <p className="w-60">cited excessive data use as a major barrier to consistent use of digital platforms</p>
        ...
        <GridItem
          ...
          className="lg:col-start-7 lg:col-span-6 lg:row-span-2 overflow-hidden px-10 flex flex-col"
        >
          <div className="flex flex-col md:flex-row justify-between items-center h-full]">
              ...
              <div className="">
                <div className="flex justify-start">
                  ...
                  <div className="flex flex-col gap-1 justify-end ml-10 w-48">
                    ...
                    <p className="font-normal text-sm">use smartphones for education or job search</p>
                  </div>
                </div>
            ...
            <div className="flex flex-col justify-end h-full text-center md:text-right pt-4">
             
              <span className="mt-auto cursor-pointer self-center md:self-end">
                <svg
                  className="size-12"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
        ...
        >
          ...
          <div className="text-[22px] font-normal w-[263px]">
            Edtech platforms<br /> must meet learners<br /> where they are
          </div>
          <div className="border-b border-[#F2BA0F] w-full mt-auto"></div>
          <p className="font-normal mt-4">To truly scale access to education</p>
        </GridItem>
  ...
  return (
     <HorizontalScrollCanvas>
           ...
           <div className="w-screen flex h-full relative">
             ...
             <h1 className="absolute top-14 left-10 text-[#F1EADA] font-extrabold text-[100px] 2xl:text-[120px] z-10 [w-863px] leading-22">
               LEARNING <br/>
               WITHOUT LIMITS
             </h1>
             <div className="bg-[#3E2F5B] pt-72 pl-10 w-1/2 text-[#F7F7F7] p-10 space-y-4 text-xl">
             ...
             <div className="w-1/2 h-full relative bg-[#FF8651]">
               ...
               <div className="absolute inset-0 bg-[#14003DB2]/80" />
           ...
           <div className="w-screen flex h-full relative">
             {/* Left Half: Text Content */}
             <h1 className="absolute top-14 left-10 text-[#F2BA0F] w-[800px] font-extrabold text-[100px] 2xl:text-[120px] z-10 leading-22 ">
               PATHWAYS TO LIVELIHOOD
             </h1>
             <div className="bg-[#000F07] pt-72 pl-10 w-1/2 text-[#F7F7F7] p-10 space-y-4 text-xl">
               <div className="xl:w-[550px] text-lg">
                 <p>
             ...
             <div className="w-1/2 h-full relative bg-[#FF8651]">
               ...
               {/* Semi-transparent overlay */}
               <div className="absolute inset-0 bg-[#000000B2]/70" />
